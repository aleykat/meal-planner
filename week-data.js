...
const WEEK = {
  ...
  bank: [
    { name: "Fajita-rubbed chicken bags, sealed raw", qty: "4 bags (1.4 lb each)", location: "freezer", useBy: "2026-12-02", note: "DEFERRED AGAIN (3rd time) — not this week. Keeps fine frozen for whenever it lands" },
